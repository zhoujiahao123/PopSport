...
public class MultiView extends ViewGroup {
    ...
    public MultiView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, cn.lemon.multi.R.styleable.MultiView);
        divideSpace = (int) typedArray.getDimension(cn.lemon.multi.R.styleable.MultiView_divideSpace, Util.dip2px(2));
        placeholder = typedArray.getResourceId(cn.lemon.multi.R.styleable.MultiView_placeholder, -1);
        typedArray.recycle();
    }
