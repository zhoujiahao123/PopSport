    ...
    public void onSensorChanged(SensorEvent event) {
        if(stepSensor == 0){
            ...
            if(!hasRecord){
                ...
                Toast.makeText(BaseApplication.mContext,"tempStepCount:"+tempStep +"hasStepCount:"+hasStepCount+" privousStepCount:"+previousStepCount
                        +" CURRENT_STEP:"+ CURRENT_STEP, Toast.LENGTH_SHORT).show();
            }
